...
(2,2,'Bella','James','Ronald','Loan','Manager',3);
...
select e2.emp_no,e2.mngr_no,concat(e1.fname,' ',e1.lname)as name ,
concat(e2.fname,' ',e2.lname) as manager_name 
from employee as e1 join employee as e2 
on e1.emp_no = e2.mngr_no;
